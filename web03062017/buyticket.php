...
<!-- validar caracteres nos fields do form para nao haver injeccao de codigo-->
	...
	<div class="form-group float-label-control">
		...
		<input class="form-control" type="tel" name="phone" maxlength="20"> <!--check if input type tel works-->
	...
	<div class="form-group float-label-control">
        ...
        <br>
	<div class="form-group float-label-control">
            <label form="">Card type</label><!-- 				VER BOOTSTRAP						-->
	...
	<div class="form-group float-label-control">
            <label form="">Name on card</label>
            <input class="form-control" type="text" maxlength="50" name="customer_name" required>
        </div>
	<div class="form-group float-label-control">
            <label form="">Special Instructions</label>
            <textarea class="form-control" rows="4" name="comments" maxlength="500"></textarea>
        </div>
	<div class="form-group float-label-control">
		<!--<input type="submit" name='submit' value="Submit">-->
		<button class="btn btn-default center-block" type="submit" name="submit" value="Submit">Submit</button>
        </div>
	</form>
	</div>
</div>
